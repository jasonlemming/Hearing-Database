...
CREATE TABLE hearings (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, hearing_date_only DATE, hearing_time TIME, video_url TEXT, youtube_video_id TEXT, video_type TEXT,
...
CREATE TABLE update_logs (
                ...
                , trigger_source TEXT DEFAULT 'manual', schedule_id INTEGER REFERENCES scheduled_tasks(task_id));
